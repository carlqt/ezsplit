...
func (r *ReceiptRepository) UnsafeCreate(receipt *Receipt) error {
...
// TODO: Change function signature to take individual values because we want to avoid creating SlugURL for this function
